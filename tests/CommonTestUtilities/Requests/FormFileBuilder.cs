...
public class FormFileBuilder
{
    public static IFormFile Png()
    {
        ...
        var file = new FormFile(stream, 0, stream.Length, "File", "IMG0001.png")
        {
    ...
    public static IFormFile Jpg()
    {
        ...
        var file = new FormFile(stream, 0, stream.Length, "File", "IMG0001.jpg")
        {
            Headers = new HeaderDictionary(),
    ...
    public static IFormFile Txt()
    {
        ...
        var file = new FormFile(stream, 0, stream.Length, "File", "FILE0001.txt")
        {
            Headers = new HeaderDictionary(),
